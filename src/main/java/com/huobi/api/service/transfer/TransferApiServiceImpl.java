...
public class TransferApiServiceImpl implements TransferApiService {
    ...
    public UsdtSwapTransferResponse transfer(UsdtSwapTransferRequest request) {
        ...
        try {
            ...
            params.put("margin_account", request.getMargin_account());
            params.put("currency",request.getCurrency());
            params.put("amount",request.getAmount());
            body = HbdmHttpClient.getInstance().doPost(api_key, secret_key, url_prex + HuobiLinearSwapAPIOptions.USDT_SWAP_TRANSFER, params);
